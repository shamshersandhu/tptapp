<div class="modal" tabindex="-2" id="mdl_edit_con" role="dialog">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div id="con_area_edit" class="modal-body modal-bd">
                        ...
                        <div class="form-row" style="margin-bottom: 8px;">
                            <div class="col">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input required type="text" class="form-control" id="ename" maxlength="60" placeholder="Person or Company Name">
                                </div>
                            </div>
                            <div class="col">
                                <div class="input-group input-group-sm">
                        ...
                        <div class="form-row" style="margin-bottom: 8px;">
                            ...
                            <div class="col">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input required class="form-control" id="ephone1" maxlength="20" placeholder="Main Phone">
                                </div>
                            </div>
                            <div class="col">
                                <div class="input-group input-group-sm">
